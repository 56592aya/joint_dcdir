...
N, K1, K2, alpha_vec, Alpha,Theta_vec, Theta, Theta1, Theta2,
fixed_len1, fixed_len2,phi1, phi2, γ = init_param_3(5, 5, 6, 2000, 2000)

# norm_grad_results = update_γ(10, N, K1, K2, γ, Alpha, phi1, phi2)
# norm_grad_results = update_γ_2(1, N, K1, K2, γ, Alpha, phi1, phi2)
norm_grad_results = update_γ_3(N, K1, K2, γ, Alpha, phi1, phi2)
...
display([compute_∇ℒ_γ_atom_3(K1, K2, k1, k2,Alpha,γ[i],phi1[i], phi2[i]) for k1 in 1:K1 for k2 in 1:K2])
