...
inds2 = deepcopy(l)
Plots.heatmap(B1_est[inds1,:], yflip=true)
Plots.heatmap(B1_truth, yflip=true)
Plots.heatmap(B2_est[inds2,:], yflip=true)
Plots.heatmap(B2_truth, yflip=true)
...
theta_truth_2 = zeros(Float64, (length(theta_truth), 5))
...
theta_est_2 = zeros(Float64, (length(theta_truth), 5))
...
i = 1;scatter(theta_truth_1[:,i], theta_est_1[:,i], grid=false, aspect_ratio=:equal,legend=false);
plot!(x, y, linewidth=3);
savefig("../theta1_$(i).png")
